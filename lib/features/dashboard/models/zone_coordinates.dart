// GENERATED from the IANA time zone database's `zone.tab` (public domain),
// as shipped in macOS's /usr/share/zoneinfo. Do not edit by hand: regenerate
// it from a newer `zone.tab` if a zone is ever missing.
//
// One entry per zone: where the zone's own principal city is, to two
// decimal places -- about a kilometre, far finer than a sky needs. Home's
