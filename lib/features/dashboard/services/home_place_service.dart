...
// Where the phone roughly is, for Home's sky: the principal city of its time
// zone. No permission, no network. `sun_times.dart` holds why.
//
// Owned by the dashboard feature and read by nobody else, so it is
// registered in `DashboardModule`, not in the service locator.
